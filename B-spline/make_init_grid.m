...
% 
%  inputs,
%    Spacing: Spacing of the b-spline grid knot vector  网格节点向量
...
if(length(Spacing)==2)   %判断小格子最大维度是二维的，若为空返回0
    % Determine grid spacing
    dx=Spacing(1); dy=Spacing(2);    %dx=dy=16 

    % Calculate te grid coordinates (make the grid)  直角坐标网间隔16   网格比图像大一圈
